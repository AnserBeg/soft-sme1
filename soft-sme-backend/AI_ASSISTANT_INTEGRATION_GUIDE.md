# Soft-SME AI Assistant Integration Guide

## Overview

The Soft-SME AI Assistant is a comprehensive AI system integrated directly into the backend that provides:

1. **Documentation Q&A**: Answers questions about Soft-SME features using RAG (Retrieval-Augmented Generation)
...
// {
//   response: "Based on the Soft-SME documentation...",
...
This AI assistant is part of the Soft-SME application and follows the same licensing terms. 