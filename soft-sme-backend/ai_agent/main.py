#!/usr/bin/env python3
"""
Soft-SME AI Agent Server
========================

FastAPI server that provides AI assistant capabilities for the Soft-SME application.
...
from agent import SoftSMEAgent
...
app = FastAPI(
    title="Soft-SME AI Agent",
    description="AI Assistant for Soft-SME Inventory Management System",
    version="1.0.0"
)
...
async def startup_event():
    ...
    global ai_agent
    try:
        logger.info("Starting Soft-SME AI Agent...")
        ai_agent = SoftSMEAgent()
