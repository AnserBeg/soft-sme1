...
- [ ] Implement `AggregationCoordinator` class inside `soft-sme-backend/ai_agent/aggregation.py`.
...
- [ ] Write integration tests simulating concurrent subagent completions.
