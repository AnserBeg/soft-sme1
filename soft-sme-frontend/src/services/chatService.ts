...
export const chatService = {
  ...
  getFallbackResponse(message: string): string {
    ...
    if (lowerMessage.includes('hello') || lowerMessage.includes('hi')) {
      return "Hello! I'm your AI assistant for the Aiven business management system. How can I help you today?";
    }
    ...
    if (lowerMessage.includes('help') || lowerMessage.includes('support')) {
      return "I'm here to help! You can ask me about any aspect of the Aiven system - inventory, customers, orders, time tracking, or general navigation. What would you like to know?";
    }
    
    return "I'm here to help you with the Aiven business management system. You can ask me about inventory, customers, purchase orders, sales, time tracking, or any other features. How can I assist you?";
  }
}; 