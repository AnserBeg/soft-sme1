...
# This script migrates all remaining data with proper handling

$env:PGPASSWORD = "123"

Write-Host "Starting complete final migration..." -ForegroundColor Green
...
Write-Host "`nComplete migration finished successfully!" -ForegroundColor Green
