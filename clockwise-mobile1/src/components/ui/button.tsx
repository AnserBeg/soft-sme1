...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        default: "bg-gradient-primary text-primary-foreground hover:shadow-button shadow-mobile",
        success: "bg-gradient-success text-success-foreground hover:shadow-button shadow-mobile",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90 shadow-mobile",
        ...
        mobile: "bg-gradient-primary text-primary-foreground hover:shadow-button shadow-mobile text-base font-semibold",
      },
      size: {
        ...
        mobile: "h-12 px-6 py-3 text-base font-semibold min-w-[120px]",
        icon: "h-10 w-10",
      },
    },
    defaultVariants: {
