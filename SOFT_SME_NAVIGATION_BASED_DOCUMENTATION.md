# Soft SME Application - Navigation-Based Complete Documentation
...
Soft SME is a comprehensive business management application designed for small and medium enterprises. The application provides integrated modules for purchasing, sales, inventory management, employee management, time tracking, and financial operations with QuickBooks Online integration.
...
- **Mapping Configuration**: Map Soft SME operations to QBO accounts
